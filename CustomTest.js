...
function PostmanTest(redlineApi, testNum, rand, config)
{
	...
	this.newmanCollection = './Redline13.postman_collection';
	this.newmanEnvironment = './redline.postman_environment';
	this.newmanGlobals = null;
	this.newmanIterations = 12;
	this.newmanData = './data.json';
}
